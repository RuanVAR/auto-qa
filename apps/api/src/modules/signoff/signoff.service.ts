...
export class SignoffService {
  ...
  async getCertificateHtml(
    ...
    const orgName = proj?.org?.name ?? proj?.name ?? 'AdVantage';
...
<style>
  *{box-sizing:border-box} body{font-family:-apple-system,Segoe UI,Roboto,sans-serif;color:#0f172a;margin:0;padding:40px;max-width:880px;margin:0 auto}
  ...
  <p class="stamp">Generated by the AdVantage sign-off system. This certificate reflects the recorded sign-off state at generation time.</p>
</body></html>`;
  }
