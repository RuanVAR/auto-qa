# QA Automation Platform — Codex Instructions
...
> **Doc location:** the planning docs referenced below live in the sibling repo
> `../QA_Planning_docs/docs/`, NOT in this repo's `docs/` folder. The repo's
> own `docs/` only contains `ISSUE_VIEWER.md`. When a row says
> `docs/ARCHITECTURE.md`, read `../QA_Planning_docs/docs/ARCHITECTURE.md`.
...
| AI provider | Anthropic Codex (default); switchable via `AI_PROVIDER` env var |
